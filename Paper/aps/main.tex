...
%(anti-)deuterons, \mbox{(anti-)}\hethree\ and (anti-)\hthreelambda~\cite{Adam:2015yta} 
...
%which would significantly enhance the phase space for its production, 
...
%, where $A = 4$ (hyper-)nuclei and other rare composite objects will become experimentally accessible, 
