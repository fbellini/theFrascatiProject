...
F. Bellini and A. Kalweit \footnote{Contacts: fbellini@cern.ch, akalweit@cern.ch}
\\European Organization for Nuclear Research (CERN), Geneva, Switzerland

\medskip

5$^{\mathrm{th}}$ September 2018
\end{center}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=\textwidth]{theory_coalescence_Cd_B2.png}
