...
void MakeFigures5TeVHeliumPaper()
{
    TString figPath = "./paper4HePbPb";
   ...
   //Make3HepPbPaperFigure(figPath.Data(), 0.733, 0, 1, 1, 0, 0);
    ...
    for (int i = 0; i<gB3vsR_pp7TeV_sys[ip]->GetN(); i++){
     Printf("dN/deta = %5.3f", gB3vsR_pp7TeV_sys[ip]->GetX()[i]);
    } 
    ...
    // pToAb4 = 0.75;
    // pToAb4Lambda = 0.62;
    TGraphAsymmErrors* gBlastB2vsR_PbPb502TeV = (TGraphAsymmErrors *)  getBAthermalBlast("PbPb502TeV", "deuteron", pToA, kBlue, paramSet, convertToR);
    TGraphAsymmErrors* gBlastB3vsR_PbPb502TeV = (TGraphAsymmErrors *)  getBAthermalBlast("PbPb502TeV", "He3", pToAb3, kBlue, paramSet, convertToR);
    TGraphAsymmErrors* gBlastB3LambdavsR_PbPb502TeV = (TGraphAsymmErrors *) getBAthermalBlast("PbPb502TeV", "hyper-triton", pToAb3Lambda, kBlue, paramSet, convertToR);
    TGraphAsymmErrors* gBlastB4vsR_PbPb502TeV = (TGraphAsymmErrors *) getBAthermalBlast("PbPb502TeV", "He4", pToAb4, kBlue, paramSet, convertToR);
    TGraphAsymmErrors* gBlastB4LambdavsR_PbPb502TeV = (TGraphAsymmErrors *) getBAthermalBlast("PbPb502TeV", "4LH", pToAb4Lambda, kBlue, paramSet, convertToR);
    
    TGraphAsymmErrors* gBlastB2vsR_PbPb276TeV = (TGraphAsymmErrors *)  getBAthermalBlast("PbPb276TeV", "deuteron", pToA, kGreen+2, paramSet, convertToR);
    TGraphAsymmErrors* gBlastB3vsR_PbPb276TeV = (TGraphAsymmErrors *)  getBAthermalBlast("PbPb276TeV", "He3", pToAb3, kGreen+2, paramSet, convertToR);
    TGraphAsymmErrors* gBlastB3LambdavsR_PbPb276TeV = (TGraphAsymmErrors *) getBAthermalBlast("PbPb276TeV", "hyper-triton", pToAb3Lambda, kGreen+2, paramSet, convertToR);
    TGraphAsymmErrors* gBlastB4vsR_PbPb276TeV = (TGraphAsymmErrors *) getBAthermalBlast("PbPb276TeV", "He4", pToAb4, kGreen+2, paramSet, convertToR);
    TGraphAsymmErrors* gBlastB4LambdavsR_PbPb276TeV = (TGraphAsymmErrors *) getBAthermalBlast("PbPb276TeV", "4LH", pToAb4Lambda, kGreen+2, paramSet, convertToR);
    ...
    TFile * fout = new TFile(Form("%s/BApredictions.root",figPath.Data()),"RECREATE");
    fout->cd();
    hframe3->Write();
    hB3_coalescence->Write();
    gBlastB3vsR_PbPb502TeV->SetName("gBlastB3vsR_PbPb502TeV");
    gBlastB3vsR_PbPb502TeV->Write();
    hframe4->Write();
    hB4_coalescence->Write();
    gBlastB4vsR_PbPb502TeV->SetName("gBlastB4vsR_PbPb502TeV");
    gBlastB4vsR_PbPb502TeV->Write();
    //cr4->Write();
