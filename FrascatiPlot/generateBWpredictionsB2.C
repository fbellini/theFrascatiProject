...
{    
 ...
 /* Double_t bt[10]    = {0.086, 0.088, 0.091, 0.094, 0.099, 0.106, 0.104, 0.127, 0.147, 0.163};
  ...
  //Published   
  Double_t bb[10]    = {0.663, 0.660, 0.655, 0.643, 0.622, 0.595, 0.557, 0.506, 0.435, 0.355};
  Double_t bberr[10] = {0.003, 0.003, 0.003, 0.003, 0.003, 0.004, 0.005, 0.008, 0.011, 0.016};
  
  Double_t bt[10]    = {0.090, 0.091, 0.094, 0.097, 0.101, 0.108, 0.115, 0.129, 0.147, 0.161};
  Double_t bterr[10] = {0.003, 0.003, 0.003, 0.003, 0.003, 0.003, 0.003, 0.005, 0.006, 0.006};

  Double_t bn[10]    = {0.735, 0.736, 0.739, 0.771, 0.828, 0.908, 1.052, 1.262, 1.678, 2.423};
  Double_t bnerr[10] = {0.013, 0.013, 0.013, 0.014, 0.015, 0.019, 0.024, 0.043, 0.088, 0.208};

  Double_t multi[10]    = {1943.0, 1587.0, 1180.0, 786.0, 512.0, 318.0, 183.0, 96.3, 44.9, 17.52};
  Double_t multierr[10] = {56., 47.0, 31.0, 20.0, 15.0, 12.0, 8.0, 5.8, 3.4, 1.84};

  //pi+  + pi- 
  Double_t dNdyPion[10]    = {1699.80, 1377.49, 1039.47, 712.92, 467.76, 292.91, 171.14, 88.82, 41.69, 16.31};
  Double_t dNdyErrPion[10] = {116.91, 66.90, 47.36, 36.06, 23.97, 15.80, 9.77, 5.21, 2.49, 0.91};

//p+pbar 
  Double_t dNdyProt[10]    = {74.56, 61.51, 47.40, 33.17, 22.51, 14.46, 8.71, 4.74, 2.30, 0.92};
  Double_t dNdyErrProt[10] = { 3.75, 2.93, 2.20, 1.50, 1.01, 0.66, 0.40, 0.27, 0.14, 0.06};
