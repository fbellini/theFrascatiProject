...
Nuclei form at chemical freeze-out and their yields are determined only by mass and chemical freeze-out temperature:  dN/dy ~ exp (-m/Tch)
pT spectra have been modeled with a Blast-Wave parameterization, with params. fixed by fit to ?,K,p

Normalisation for the spectra is fixed to the d/? (3He/?) ratio from thermal model times the measured ? yield. 

Normalisation for 3LH is extracted from the 3He and the S3 predicted by thermal model
