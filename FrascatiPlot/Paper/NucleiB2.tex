...
\centering
\begin{tabularx}{\textwidth}{XcccccXc}
...
Mass \newline number & Nucleus                         & Composition                  & $B_{E}$ (MeV)   & Spin $J$ & (charge) rms \newline radius (fm) &  harmonic oscillator  \newline width r (fm)  & Refs. \\ \hline
...
\multirow{4}{*}{A = 4}  & \hefour                          & ppnn                              &    28.29566   (20)  &      0  &  1.6755 $\pm$ 0.0028  &             & \cite{1674-1137-41-3-030003,Angeli:2013epw} \\
                                   ...
                                   & \hfourtwolambda          &  p$\Lambda\Lambda$n &   0.39 -- 0.51         &    1 (cf text in \cite{Nemura:1999qp})    &    4.2 -- 7.1                      &           &   \cite{Nemura:1999qp} \\
                                   & \hefourlambda              & pp$\Lambda$n              &  2.39 $\pm$ 0.03  &    0   &    2.0 -- 3.8                     &            & \cite{Davis:2005mb,Nemura:1999qp}\\ \hline
\end{tabularx}
