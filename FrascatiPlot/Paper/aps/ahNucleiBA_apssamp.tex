...
%\altaffiliation[Also at ]{European Organization for Nuclear Research (CERN), Geneva, Switzerland}%Lines break automatically or can be forced with \\
...
%\appendix
%\section{Relation to the Sato-Yazaki coalescence model}
%\input{appendixA}
%
%\appendix
%\section{RMS of a gaussian wave-function for $\mathbf{A=4}$}
%\input{appendixB}
%
%\appendix
